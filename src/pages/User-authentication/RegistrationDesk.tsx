...
const RegistrationDesk = () => {
  ...
  return (
    <div className='flex flex-col items-center p-6 sm:p-10 w-full min-h-screen bg-[#f3f4f6]'>
      <img className='w-60 sm:w-80' src={headerimg} />
      <h1 className='mt-10 sm:mt-20 text-[#1F2937] text-lg font-medium text-center mb-4'>Registration</h1>

      <div className='flex flex-col items-center w-full max-w-[914px]'>
        <div className='grid gap-6 items-center grid-cols-1 md:grid-cols-2 mb-16 w-full'>
          
          {/* Name Input */}
          <div className='flex items-center relative'>
            <SimpleInputField imgpath={profile} active='default' label='Name' />
            <div
              className='absolute right-6 sm:right-4'
              onMouseEnter={handlePasswordMouseEnter}
              onMouseLeave={handlePasswordMouseLeave}
            >
              <img className='h-5 sm:h-4' src={info} alt="Info" />
              {hoveredInfo && (
          ...
          <div className='flex items-center relative justify-between'>
            ...
            >
              <img className='h-5 sm:h-4 mx-2' src={info} alt="Info" />
              {hoveredEmailInfo && (
        ...
        <h1 className='mt-8 text-[#1F2937] text-sm font-normal text-center'>
